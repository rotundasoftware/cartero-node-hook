...
test( 'example3', function( t ) {
	...
	hook.getParcelTags( path.join( __dirname, 'example3/views/page1' ), function( err, scriptTags, styleTags ) {
		if( err ) throw err;
...
test( 'example3 (no baseUrl)', function( t ) {
	...
	hook.getParcelTags( path.join( __dirname, 'example3/views/page2' ), function( err, scriptTags, styleTags ) {
		if( err ) throw err;
