...
test( 'example3', function( t ) {
	...
	hook.getParcelAssets( path.join( __dirname, 'example3/views/page1' ), function( err, result ) {
		if( err ) throw err;
	...
	hook.getParcelTags( path.join( __dirname, 'example3/views/page1' ), function( err, result ) {
		if( err ) throw err;
...
test( 'example3 (no baseUrl)', function( t ) {
	...
	hook.getParcelAssets( path.join( __dirname, 'example3/views/page2' ), function( err, result ) {
		if( err ) throw err;
	...
	hook.getParcelTags( path.join( __dirname, 'example3/views/page2' ), function( err, result ) {
		if( err ) throw err;
	
		t.deepEqual( result, {
			script : '<script type=\'text/javascript\' src=\'/ea7138e6b6eea6321eb1926e8ac88d65f16aa51d/page2_bundle_5066f9594b8be17fd6360e23df52ffe750206020.js\'></script>',
			style : '<link rel=\'stylesheet\' href=\'/ea7138e6b6eea6321eb1926e8ac88d65f16aa51d/page2_bundle_182694e4a327db0056cfead31f2396287b7d4544.css\'></link>' }
		);
	} );
} );